       ...
       $collection = Mage::getResourceModel($this->_getCollectionClass());
            /*$collection->join(
                ...
                $collection->getSelect()->group('entity_id');*/
 				...
 				$collection->getSelect()->joinLeft(array('sfoa'=>'clay_sales_flat_order_address'),
				...
				$collection->getSelect()->joinLeft(array('payment'=>'clay_sales_flat_order_payment'),'main_table.entity_id=payment.parent_id',array('payment.method'));
				
				$collection->getSelect()->joinLeft(array('sfoa1'=>'clay_sales_flat_shipment_track'),
					'main_table.entity_id = sfoa1.order_id',array('sfoa1.title'));
