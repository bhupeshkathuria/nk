...
class Clay_Salesreport_Model_Supplier extends Mage_Core_Model_Abstract {
    private $_userTbl;

    public function _construct() {
        parent::_construct();
        $this->_init('salesreport/salesreport');

        $this->_userTbl = Mage::getSingleton('core/resource')->getTableName('salesreport_user');
