...
class Clay_Courier_Model_Supplier extends Mage_Core_Model_Abstract {
    private $_userTbl;

    public function _construct() {
        parent::_construct();
        $this->_init('courier/courier');

        $this->_userTbl = Mage::getSingleton('core/resource')->getTableName('courier_user');
