<?php
class Clay_Courier_Block_Abstract extends Mage_Core_Block_Template {
	...
	public function getOrderIdByShippingId($shippingid) {
		...
		$shipping = Mage::getModel('courier/order')->getOrderIdByShippingId($shippingid);
	...
	public function getCartItems($order){
		...
		$items = Mage::getModel('courier/order')->getCartItemsBySupplier($supplierId,$order->getEntityId());
		$bundle = false;	
