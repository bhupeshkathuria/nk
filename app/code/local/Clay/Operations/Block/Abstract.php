<?php
class Clay_Operations_Block_Abstract extends Mage_Core_Block_Template {
	...
	public function getOrderIdByShippingId($shippingid) {
		...
		$shipping = Mage::getModel('operations/order')->getOrderIdByShippingId($shippingid);
	...
	public function getCartItems($order){
		...
		$items = Mage::getModel('operations/order')->getCartItemsBySupplier($supplierId,$order->getEntityId());
		$bundle = false;	
	...
	public function getOrderData($orderId) {
        $session = Mage::getSingleton('core/session');
        $supplierId = $session->getData('courierId');
        $supplierModel = Mage::getModel('courier/courier');
