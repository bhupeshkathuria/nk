...
#footer .custom-footer-content .block-tags .actions a:hover,
button.button:hover > span,
ul.social-links li a i:hover,
#footer .custom-footer-content .block-tags .tags-list li a:hover,
...
if ($this->baseColors['base_override'] == 1) {
    ...
    #footer .custom-footer-content ul.links li a {color: #' . $this->footerColors['footer_top_link'] . ';}
    #footer .custom-footer-content ul.links li a:hover {color: #' . $this->footerColors['footer_top_link_h'] . ';}
    #footer .custom-footer-content ul.links li:after {background-color: #' . $this->footerColors['footer_top_link_bg_h'] . ';}
    #footer .custom-footer-content ul.links li:before {background-color: #' . $this->footerColors['footer_top_link_bg'] . ';}
    ...
    #footer .footer-second-line .custom-footer-content ul.links li a,
    ...
    #footer .footer-second-line .custom-footer-content ul.links li:before,
    #footer .footer-second-line .footer-links li a {background-color: #' . $this->footerColors['footer_medium_link_bg'] . ';}
    #footer .footer-second-line .custom-footer-content ul.links li:after,
    ...
    #footer address {color: #' . $this->footerColors['footer_bottom_text'] . ';}
    #footer address a {color: #' . $this->footerColors['footer_bottom_link'] . ';}
