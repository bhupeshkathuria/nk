...
<body <?php body_class(); ?>>
	...
	<div class="search-header">
		...
		<input placeholder="Search GoodLook" type="text" value="<?php get_search_query(); ?>" name="s" id="s" />
		<input class="btn-search" type="submit" id="searchsubmit" value="<?php esc_attr_x( 'Search', 'submit button' ); ?>" />
	</div>
</form>
		</hgroup>
